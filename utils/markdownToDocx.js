...
exports.serveDocx = serveDocx;
const docx_1 = require("docx");
const markdown_it_1 = __importDefault(require("markdown-it"));
const axios_1 = __importDefault(require("axios"));
const md = new markdown_it_1.default({ html: false, linkify: true, typographer: true, breaks: true });
...
function markdownToDocx(markdownContent) {
    return __awaiter(this, void 0, void 0, function* () {
        const tokens = md.parse(markdownContent, {});
        const docChildren = [];
        let currentParagraphRuns = [];
        let currentHeadingStyleId = undefined;
        ...
        const flushParagraph = () => {
            if (currentParagraphRuns.length > 0) {
                ...
                docChildren.push(new docx_1.Paragraph(paragraphConfig));
        ...
        for (let i = 0; i < tokens.length; i++) {
            ...
            switch (token.type) {
                ...
                case 'inline':
                    if (token.children) {
                        for (const child of token.children) {
                            let textRunOptions = { font: "Times New Roman", size: 24 };
                            if (child.type === 'text') {
                                ...
                                if (src) {
                                    const imageBuffer = yield downloadImage(src);
                                    if (imageBuffer) {
                                        try {
                                            ...
                                            docChildren.push(new docx_1.Paragraph({
                                                children: [new docx_1.ImageRun(imageRunOptions)],
                                                alignment: docx_1.AlignmentType.CENTER,
                                                spacing: { after: 120 },
                                            }));
                                            if (alt) {
                                                docChildren.push(new docx_1.Paragraph({
                                                    children: [new docx_1.TextRun({ text: alt })],
                                                    style: "ImageCaption",
                                                }));
                                            }
                                        }
                                            ...
                                            docChildren.push(new docx_1.Paragraph({ text: `[Imagem indisponível: ${alt}]`, style: "Normal", alignment: docx_1.AlignmentType.CENTER }));
                                        }
                                    }
                                    else {
                                        docChildren.push(new docx_1.Paragraph({ text: `[Falha ao carregar imagem: ${alt}]`, style: "Normal", alignment: docx_1.AlignmentType.CENTER }));
                                    }
                                }
                                continue;
                            }
                                ...
                                if (k < token.children.length)
                                    token.children.splice(token.children.indexOf(child) + 1, k - (token.children.indexOf(child)));
                            }
                            ...
                            if (textRunOptions.text || textRunOptions.break) {
                                if (textRunOptions.style === "Hyperlink") {
                                    currentParagraphRuns.push(new docx_1.TextRun(Object.assign(Object.assign({}, textRunOptions), { font: "Times New Roman", size: 24 })));
                                }
                                else {
                                    currentParagraphRuns.push(new docx_1.TextRun(textRunOptions));
                                }
                            }
                        }
                    }
                ...
                case 'fence':
                    flushParagraph();
                    docChildren.push(new docx_1.Paragraph({
                        children: [new docx_1.TextRun({ text: token.content })],
                ...
                case 'hr':
                    flushParagraph();
                    docChildren.push(new docx_1.Paragraph({
                        children: [new docx_1.TextRun("___________________________")],
                        style: "Normal",
                        alignment: docx_1.AlignmentType.CENTER,
                ...
                case 'table_close':
                    if (tableRows.length > 0) {
                        docChildren.push(new docx_1.Table({
                            ...
                            borders: {
                                top: { style: docx_1.BorderStyle.SINGLE, size: 1, color: "auto" },
                                bottom: { style: docx_1.BorderStyle.SINGLE, size: 1, color: "auto" },
                                left: { style: docx_1.BorderStyle.SINGLE, size: 1, color: "auto" },
                                right: { style: docx_1.BorderStyle.SINGLE, size: 1, color: "auto" },
                                insideHorizontal: { style: docx_1.BorderStyle.SINGLE, size: 1, color: "auto" },
                                insideVertical: { style: docx_1.BorderStyle.SINGLE, size: 1, color: "auto" },
                            }
                        }));
                    }
                    inTable = false;
                ...
                case 'tr_close':
                    if (currentRowCells.length > 0) {
                        tableRows.push(new docx_1.TableRow({
                            children: currentRowCells.map(cellParagraphs => new docx_1.TableCell({ children: cellParagraphs }))
                        }));
                    }
                    break;
                case 'th_open':
                ...
                case 'td_close':
                    flushParagraph();
                    if (docChildren.length > 0 && docChildren[docChildren.length - 1] instanceof docx_1.Paragraph) {
                        const cellPara = docChildren.pop();
                        currentRowCells.push([cellPara]);
                    }
                    else if (currentParagraphRuns.length > 0) {
                        currentRowCells.push([new docx_1.Paragraph({ children: [...currentParagraphRuns], style: "Normal" })]);
                        currentParagraphRuns = [];
                    }
                    else {
                        currentRowCells.push([new docx_1.Paragraph({ text: "", style: "Normal" })]);
                    }
                    currentParagraphRuns = [];
                    break;
            }
        ...
        const doc = new docx_1.Document({
                ...
                paragraphStyles: [
                    ...
                    },
                    {
                        ...
                        paragraph: {
                            ...
                            shading: { type: docx_1.ShadingType.CLEAR, fill: "F0F0F0" },
                        },
                    },
                    {
                        id: "BlockquoteStyle",
            ...
            numbering: {
                config: [{
                        ...
                        levels: [{
                                level: 0, format: "bullet", text: "•", alignment: docx_1.AlignmentType.LEFT,
                                style: {
                                    paragraph: {
                                ...
                                level: 1, format: "bullet", text: "◦", alignment: docx_1.AlignmentType.LEFT,
                                style: {
                                    paragraph: {
...
function serveDocx(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const buffer = yield markdownToDocx(markdownContent);
